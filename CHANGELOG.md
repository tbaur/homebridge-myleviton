...
## [4.0.2](https://github.com/tbaur/homebridge-myleviton/compare/v4.0.1...v4.0.2) (2026-09-13)


### Bug Fixes

* redact JSON emails and keep env passwords off config.json ([#80](https://github.com/tbaur/homebridge-myleviton/issues/80)) ([3a9852a](https://github.com/tbaur/homebridge-myleviton/commit/3a9852ab4cab77e99f73de902574b1a96a2600f5))
...
* **deps:** patch js-yaml omap DoS and refresh dev dependency tree ([#65](https://github.com/tbaur/homebridge-myleviton/issues/65)) ([2aa9fcb](https://github.com/tbaur/homebridge-myleviton/commit/2aa9fcb6ebeb31c3ecc2a5c15fa091941b6f2e9b))

...
> Required checks on the Release PR are now possible, because its runs do execute
> once approved. They would make approval mandatory instead of advisory. Removing
> the approval step altogether needs a GitHub App or a PAT.

 ...
 */
import type { API, Characteristic, CharacteristicProps, HAP, PlatformAccessory as HomebridgePlatformAccessory, Service, WithUUID } from 'homebridge';
 ...
 */
export type ServiceRef = WithUUID<HAP['Service']> & (new (displayName?: string, subtype?: string) => Service);
/**
 ...
 */
export type CharacteristicRef = WithUUID<HAPCharacteristicRegistry> & (new () => Characteristic);
